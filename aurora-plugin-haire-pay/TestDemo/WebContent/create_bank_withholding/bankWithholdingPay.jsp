...
<%
		...
		//银行卡号加密
		String cardNo = com.client.util.Core.encryptData(request.getParameter("card_no"),inputCharset);	
		//证件号加密
		String certificatesNumber = com.client.util.Core.encryptData(request.getParameter("certificates_number"),inputCharset);
		
		sParaTemp.put("outer_trade_no", request.getParameter("outer_trade_no"));
		sParaTemp.put("user_name", request.getParameter("user_name"));
		sParaTemp.put("certificates_type", request.getParameter("certificates_type"));
		sParaTemp.put("certificates_number", certificatesNumber);
		sParaTemp.put("bank_code", request.getParameter("bank_code"));
		sParaTemp.put("card_no", cardNo);
		sParaTemp.put("payable_amount", request.getParameter("payable_amount"));
		sParaTemp.put("submit_time", request.getParameter("submit_time"));
		sParaTemp.put("notify_url", request.getParameter("notify_url"));
