...
<%
		...
		sParaTemp.put("orig_outer_trade_no", request.getParameter("orig_outer_trade_no"));
		sParaTemp.put("refund_amount", request.getParameter("refund_amount"));
		sParaTemp.put("deposit_amount", request.getParameter("deposit_amount"));
		sParaTemp.put("refund_ensure_amount", request.getParameter("refund_ensure_amount"));
		sParaTemp.put("royalty_parameters", request.getParameter("royalty_parameters"));
		sParaTemp.put("operator_id", request.getParameter("operator_id"));
		sParaTemp.put("callback_url", request.getParameter("callback_url"));
