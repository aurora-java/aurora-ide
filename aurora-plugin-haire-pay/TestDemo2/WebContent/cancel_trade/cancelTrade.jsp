...
<html>
  ...
  <body>
       <form id="form1" action="<%=request.getContextPath()%>/cancel_trade/cancelTradeService.jsp" method="post">

接口名称:  <input type="text" name="service" value="cancel_trade">(例如：cancel_trade)
<br/>
...
原始的商户网站唯一订单号: <input type="text" name="outer_trade_no" value="2013112405052323">(不可空)<br/>
交易取消原因: <input type="text" name="reason" value="">(可空)<br/>
