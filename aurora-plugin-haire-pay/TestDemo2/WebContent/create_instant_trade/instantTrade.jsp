...
<html>
  ...
  <body>
       <form id="form1" action="<%=request.getContextPath()%>/create_instant_trade/instantTradePay.jsp" method="post">

接口名称:  <input type="text" name="service" value="create_instant_trade">(例如：create_instant_trade)
<br/>
...
<br/>
 ...
 返回页面路径: <input type="text" name="return_url" value="http://122.224.203.210:18380/TestDemo/create_instant_trade/instantReturnUrlResponse.jsp">(页面跳转同步返回页面路径  可空)<br/>
...
<%		
		...
		String tradeList = orderTime+ lstStr1 +"~a啊a~0.02~1~0.01~~772106081@qq.com~1~instant~sss 5KG~http://www.kjtpay.com/?product-9.html~0~~~20140826164521~http://122.224.203.210:18380/TestDemo/create_instant_trade/instantNotifyUrlResponse.jsp";
 %>
