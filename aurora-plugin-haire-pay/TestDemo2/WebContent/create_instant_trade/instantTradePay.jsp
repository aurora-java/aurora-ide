...
<%@ page language="java" import="java.util.*,java.net.*,java.lang.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<%
		...
		//String gatewayUrl = "http://localhost:8380/mag/gateway/receiveOrder.do";
         ...
         //String gatewayUrl = "http://192.168.20.217:8084/mag/gateway/receiveOrder.do";
