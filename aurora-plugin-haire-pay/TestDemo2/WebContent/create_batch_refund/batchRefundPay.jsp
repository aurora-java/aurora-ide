...
<%
		...
		sParaTemp.put("batch_no", request.getParameter("batch_no"));
		sParaTemp.put("refund_num", request.getParameter("refund_num"));
		sParaTemp.put("refund_list", request.getParameter("refund_list"));
		sParaTemp.put("operator_id", request.getParameter("operator_id"));
		sParaTemp.put("identity_no", request.getParameter("identity_no"));
		sParaTemp.put("identity_type", request.getParameter("identity_type"));
