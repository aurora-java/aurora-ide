 ...
 */
public final class CXF_CamelWSToWSExample {

	private CXF_CamelWSToWSExample() {
	}
	...
	public static void main(String args[]) throws Exception {
		...
		// jetty: http://localhost:8888/HAP_DBI/ws/query.svc
...
//				<Authorization password="b" user="a"/>
				from("direct:start")
						.to("http://localhost:8888/HAP_DBI/ws/query.svc?a=a&bridgeEndpoint=true&soapaction=&quot;&quot;")
						.process(new Processor() {

							@Override
							public void process(Exchange arg0) throws Exception {
								// Object body = arg0.getOut().getBody();
								System.out.println(arg0.getIn().getBody());
							}
						}).to("file:/Users/shiliyan/Desktop/target/a.a");
				// from("test-jms:queue:test.queue").to("http://localhost:8888/HAP_DBI/ws/save.svc");
				// from("jetty:http://localhost:9999/HAP_DBI/ws/query.svc").to("http://localhost:8888/HAP_DBI/ws/save.svc?bridgeEndpoint=true");
			}
		});
		// END SNIPPET: e3
		...
		// }
		template.sendBody("direct:start", "aa");
		// END SNIPPET: e5
