package aurora.plugin.esb.router.builder.producer;
...
//	}
	...
	public void configure() throws Exception {
		From from = producer.getFrom();
		{
			...
			final ProducerProcesser processor = ProcessorManager.getProcessor(
					producer, esbContext);
			if (processor != null) {
				...
				// store file
				begin = esbContext.getDataStore().storeData(begin, esbContext, producer);
				begin.process(
						new Processor() {
							public void process(Exchange arg0) throws Exception {
