 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.Group#getCategoryValueRef <em>Category Value Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getGroup()
...
public interface Group extends Artifact {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getGroup_CategoryValueRef()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Group#getCategoryValueRef <em>Category Value Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
