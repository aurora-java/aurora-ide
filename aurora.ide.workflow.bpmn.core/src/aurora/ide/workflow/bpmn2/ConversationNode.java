 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.ConversationNode#getParticipantRefs <em>Participant Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ConversationNode#getMessageFlowRefs <em>Message Flow Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ConversationNode#getCorrelationKeys <em>Correlation Keys</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ConversationNode#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getConversationNode()
...
public interface ConversationNode extends BaseElement, InteractionNode {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getConversationNode_ParticipantRefs()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getConversationNode_MessageFlowRefs()
	 * @model ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getConversationNode_CorrelationKeys()
	 ...
	 * @see #setName(String)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getConversationNode_Name()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.ConversationNode#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
