 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.LaneImpl#getPartitionElement <em>Partition Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.LaneImpl#getFlowNodeRefs <em>Flow Node Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.LaneImpl#getChildLaneSet <em>Child Lane Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.LaneImpl#getName <em>Name</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.LaneImpl#getPartitionElementRef <em>Partition Element Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
