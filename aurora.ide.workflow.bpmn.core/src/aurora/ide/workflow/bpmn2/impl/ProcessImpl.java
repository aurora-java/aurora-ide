...
import aurora.ide.workflow.bpmn2.FlowElementsContainer;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getLaneSets <em>Lane Sets</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getFlowElements <em>Flow Elements</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getAuditing <em>Auditing</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getMonitoring <em>Monitoring</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getArtifacts <em>Artifacts</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getCorrelationSubscriptions <em>Correlation Subscriptions</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getSupports <em>Supports</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getDefinitionalCollaborationRef <em>Definitional Collaboration Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#isIsClosed <em>Is Closed</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#isIsExecutable <em>Is Executable</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ProcessImpl#getProcessType <em>Process Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessImpl extends CallableElementImpl implements
		aurora.ide.workflow.bpmn2.Process {
	/**
	 ...
	 * @ordered
	 */
	protected EList<aurora.ide.workflow.bpmn2.Process> supports;
	 ...
	 * @generated
	 */
	public List<aurora.ide.workflow.bpmn2.Process> getSupports() {
		if (supports == null) {
			supports = new EObjectResolvingEList<aurora.ide.workflow.bpmn2.Process>(
					aurora.ide.workflow.bpmn2.Process.class, this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Bpmn2Package.PROCESS__SUPPORTS:
			getSupports().clear();
			getSupports()
					.addAll((Collection<? extends aurora.ide.workflow.bpmn2.Process>) newValue);
			return;
		case Bpmn2Package.PROCESS__DEFINITIONAL_COLLABORATION_REF:
