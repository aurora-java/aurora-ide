 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.EventBasedGateway#getEventGatewayType <em>Event Gateway Type</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.EventBasedGateway#isInstantiate <em>Instantiate</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getEventBasedGateway()
...
public interface EventBasedGateway extends Gateway {
	 ...
	 * The literals are from the enumeration {@link aurora.ide.workflow.bpmn2.EventBasedGatewayType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getEventBasedGateway_EventGatewayType()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.EventBasedGateway#getEventGatewayType <em>Event Gateway Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getEventBasedGateway_Instantiate()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.EventBasedGateway#isInstantiate <em>Instantiate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
