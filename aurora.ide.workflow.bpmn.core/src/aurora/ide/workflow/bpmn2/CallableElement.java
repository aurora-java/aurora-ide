 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.CallableElement#getSupportedInterfaceRefs <em>Supported Interface Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CallableElement#getIoSpecification <em>Io Specification</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CallableElement#getIoBinding <em>Io Binding</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CallableElement#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCallableElement()
...
public interface CallableElement extends RootElement {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCallableElement_SupportedInterfaceRefs()
	 * @model ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCallableElement_IoSpecification()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.CallableElement#getIoSpecification <em>Io Specification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link aurora.ide.workflow.bpmn2.InputOutputBinding}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCallableElement_IoBinding()
	 * @model containment="true" ordered="false"
	 ...
	 * @see #setName(String)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCallableElement_Name()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.CallableElement#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
