 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.PartnerRole#getParticipantRef <em>Participant Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.PartnerRole#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getPartnerRole()
...
public interface PartnerRole extends RootElement {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getPartnerRole_ParticipantRef()
	 * @model ordered="false"
	 ...
	 * @see #setName(String)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getPartnerRole_Name()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.PartnerRole#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
