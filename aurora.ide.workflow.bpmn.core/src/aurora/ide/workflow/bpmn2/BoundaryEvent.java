 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.BoundaryEvent#getAttachedToRef <em>Attached To Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.BoundaryEvent#isCancelActivity <em>Cancel Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getBoundaryEvent()
...
public interface BoundaryEvent extends CatchEvent {
	 ...
	 * It is bidirectional and its opposite is '{@link aurora.ide.workflow.bpmn2.Activity#getBoundaryEventRefs <em>Boundary Event Refs</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getBoundaryEvent_AttachedToRef()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.BoundaryEvent#getAttachedToRef <em>Attached To Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getBoundaryEvent_CancelActivity()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.BoundaryEvent#isCancelActivity <em>Cancel Activity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
