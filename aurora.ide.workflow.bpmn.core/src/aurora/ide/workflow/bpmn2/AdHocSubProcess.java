 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.AdHocSubProcess#getCompletionCondition <em>Completion Condition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.AdHocSubProcess#isCancelRemainingInstances <em>Cancel Remaining Instances</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.AdHocSubProcess#getOrdering <em>Ordering</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getAdHocSubProcess()
...
public interface AdHocSubProcess extends SubProcess {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getAdHocSubProcess_CompletionCondition()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.AdHocSubProcess#getCompletionCondition <em>Completion Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getAdHocSubProcess_CancelRemainingInstances()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.AdHocSubProcess#isCancelRemainingInstances <em>Cancel Remaining Instances</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link aurora.ide.workflow.bpmn2.AdHocOrdering}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getAdHocSubProcess_Ordering()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.AdHocSubProcess#getOrdering <em>Ordering</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
