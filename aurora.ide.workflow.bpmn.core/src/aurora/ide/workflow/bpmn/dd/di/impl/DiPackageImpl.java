...
import aurora.ide.workflow.bpmn.dd.di.DiFactory;
...
import aurora.ide.workflow.bpmn.dd.di.util.DiValidator;

import aurora.ide.workflow.bpmn.di.BpmnDiPackage;

import aurora.ide.workflow.bpmn.di.impl.BpmnDiPackageImpl;
...
public class DiPackageImpl extends EPackageImpl implements DiPackage {
	 ...
	 * @see aurora.ide.workflow.bpmn.dd.di.DiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
