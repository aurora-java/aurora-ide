...
import aurora.ide.workflow.bpmn.dd.di.DocumentRoot;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getDiagramElement <em>Diagram Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getDiagram <em>Diagram</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getLabeledEdge <em>Labeled Edge</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getLabeledShape <em>Labeled Shape</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getNode <em>Node</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getPlane <em>Plane</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DocumentRootImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
