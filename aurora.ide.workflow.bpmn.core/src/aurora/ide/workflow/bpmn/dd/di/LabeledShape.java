 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.LabeledShape#getOwnedLabel <em>Owned Label</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn.dd.di.DiPackage#getLabeledShape()
 * @model abstract="true"
...
public interface LabeledShape extends Shape {
	 ...
	 * @see aurora.ide.workflow.bpmn.dd.di.DiPackage#getLabeledShape_OwnedLabel()
