 ...
 * </copyright>
 */
package aurora.ide.workflow.bpmn.di.impl;

import aurora.ide.workflow.bpmn.di.BPMNDiagram;
import aurora.ide.workflow.bpmn.di.BPMNEdge;
import aurora.ide.workflow.bpmn.di.BPMNLabel;
import aurora.ide.workflow.bpmn.di.BPMNLabelStyle;
import aurora.ide.workflow.bpmn.di.BPMNPlane;
import aurora.ide.workflow.bpmn.di.BPMNShape;
import aurora.ide.workflow.bpmn.di.BpmnDiPackage;
import aurora.ide.workflow.bpmn.di.DocumentRoot;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getBPMNDiagram <em>BPMN Diagram</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getBPMNEdge <em>BPMN Edge</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getBPMNLabel <em>BPMN Label</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getBPMNLabelStyle <em>BPMN Label Style</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getBPMNPlane <em>BPMN Plane</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.DocumentRootImpl#getBPMNShape <em>BPMN Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
