...
import aurora.ide.workflow.bpmn.dd.dc.DcPackage;

import aurora.ide.workflow.bpmn.dd.dc.impl.DcPackageImpl;

import aurora.ide.workflow.bpmn.dd.di.DiPackage;

import aurora.ide.workflow.bpmn.dd.di.impl.DiPackageImpl;
...
import aurora.ide.workflow.bpmn.di.BpmnDiFactory;
...
import aurora.ide.workflow.bpmn2.impl.Bpmn2PackageImpl;
...
public class BpmnDiPackageImpl extends EPackageImpl implements BpmnDiPackage {
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
