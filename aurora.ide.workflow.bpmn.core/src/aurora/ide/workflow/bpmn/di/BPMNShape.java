 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#getLabel <em>Label</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#getBpmnElement <em>Bpmn Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#getChoreographyActivityShape <em>Choreography Activity Shape</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsExpanded <em>Is Expanded</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsHorizontal <em>Is Horizontal</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsMarkerVisible <em>Is Marker Visible</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsMessageVisible <em>Is Message Visible</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNShape#getParticipantBandKind <em>Participant Band Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape()
...
public interface BPMNShape extends LabeledShape {
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_Label()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#getLabel <em>Label</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_BpmnElement()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#getBpmnElement <em>Bpmn Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_ChoreographyActivityShape()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#getChoreographyActivityShape <em>Choreography Activity Shape</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_IsExpanded()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsExpanded <em>Is Expanded</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_IsHorizontal()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsHorizontal <em>Is Horizontal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_IsMarkerVisible()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsMarkerVisible <em>Is Marker Visible</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_IsMessageVisible()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#isIsMessageVisible <em>Is Message Visible</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link aurora.ide.workflow.bpmn.di.ParticipantBandKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNShape_ParticipantBandKind()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNShape#getParticipantBandKind <em>Participant Band Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
