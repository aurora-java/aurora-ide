 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getLabel <em>Label</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getBpmnElement <em>Bpmn Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getMessageVisibleKind <em>Message Visible Kind</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getTargetElement <em>Target Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNEdge()
...
public interface BPMNEdge extends LabeledEdge {
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNEdge_Label()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getLabel <em>Label</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNEdge_BpmnElement()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getBpmnElement <em>Bpmn Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link aurora.ide.workflow.bpmn.di.MessageVisibleKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNEdge_MessageVisibleKind()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getMessageVisibleKind <em>Message Visible Kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNEdge_SourceElement()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getSourceElement <em>Source Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNEdge_TargetElement()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNEdge#getTargetElement <em>Target Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
