...
public class FakePrototypeProject implements IProject {

	private String projectName;

	private IProject project;

	public FakePrototypeProject(IProject project) {
		super();
	...
	public String getPersistentProperty(QualifiedName key) throws CoreException {
		if (MetaProjectPropertyPage.AURORA_PROJECT_QN.equals(key))
