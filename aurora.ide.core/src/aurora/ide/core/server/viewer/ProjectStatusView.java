...
public class ProjectStatusView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		column4.setWidth(80);
		column4.setText("数据库状态");

		// Create the help context id for the viewer's control
		PlatformUI.getWorkbench().getHelpSystem()
				.setHelp(viewer.getControl(), "aaaaviewer.viewer");
		makeActions();
		hookContextMenu();
	...
	private void makeActions() {
		...
		action1.setImageDescriptor(AuroraImagesUtils
				.getImageDescriptor("debug/run_tool(1).gif"));
		action1.setDisabledImageDescriptor(AuroraImagesUtils
				.getImageDescriptor("debug/run_tool.gif"));

		action2 = new Action() {
			public void run() {
				try {
					AuroraServerLauncher.launch();
		...
		action2.setImageDescriptor(AuroraImagesUtils
				.getImageDescriptor("debug/debug_exc(1).gif"));
		action2.setDisabledImageDescriptor(AuroraImagesUtils
				.getImageDescriptor("debug/debug_exc.gif"));

		action3 = new Action() {
			public void run() {
				showMessage("Action 1 tttt,mmmtt");
			}
		};
		action3.setEnabled(false);
		action3.setText("Action 1");
		action3.setToolTipText("Action 1 tooltip");
		action3.setImageDescriptor(AuroraImagesUtils
				.getImageDescriptor("debug/terminate_co(1).gif"));
		action3.setDisabledImageDescriptor(AuroraImagesUtils
