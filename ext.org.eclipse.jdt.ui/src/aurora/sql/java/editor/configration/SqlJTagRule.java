...
public class SqlJTagRule extends PatternRule {

	public SqlJTagRule(String start,IToken token) {
		this(start +
				"{", "}", token,(char) 0,false,false);
	}
	 ...
	 */
	public SqlJTagRule(String startSequence, String endSequence, IToken token, char escapeCharacter, boolean breaksOnEOL) {
	 ...
	 * @since 2.1
	 */
	public SqlJTagRule(String startSequence, String endSequence, IToken token, char escapeCharacter, boolean breaksOnEOL, boolean breaksOnEOF) {
	 ...
	 * @since 3.0
	 */
	public SqlJTagRule(String startSequence, String endSequence, IToken token, char escapeCharacter, boolean breaksOnEOL, boolean breaksOnEOF, boolean escapeContinuesLine) {
	...
	protected IToken doEvaluate(ICharacterScanner scanner, boolean resume) {
		SqlJSourceScanner sss = (SqlJSourceScanner)scanner;
		if (resume) {
