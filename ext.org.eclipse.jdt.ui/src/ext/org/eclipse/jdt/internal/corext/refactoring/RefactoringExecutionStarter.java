 ...
 *******************************************************************************/
package ext.org.eclipse.jdt.internal.corext.refactoring;
...
import ext.org.eclipse.jdt.internal.corext.fix.CleanUpRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.base.RefactoringStatusCodes;
import ext.org.eclipse.jdt.internal.corext.refactoring.code.ConvertAnonymousToNestedRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.code.InlineConstantRefactoring;
...
import ext.org.eclipse.jdt.internal.corext.refactoring.code.IntroduceFactoryRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.code.IntroduceIndirectionRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.code.IntroduceParameterRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.code.ReplaceInvocationsRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.generics.InferTypeArgumentsRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.reorg.JavaCopyProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.reorg.JavaDeleteProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.reorg.JavaMoveProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.reorg.ReorgPolicyFactory;
import ext.org.eclipse.jdt.internal.corext.refactoring.reorg.IReorgPolicy.ICopyPolicy;
import ext.org.eclipse.jdt.internal.corext.refactoring.reorg.IReorgPolicy.IMovePolicy;
import ext.org.eclipse.jdt.internal.corext.refactoring.sef.SelfEncapsulateFieldRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.ChangeSignatureProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.ChangeTypeRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.ExtractClassRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.ExtractInterfaceProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.ExtractSupertypeProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.IntroduceParameterObjectProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.MoveInnerToTopRefactoring;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.MoveInstanceMethodProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.MoveStaticMembersProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.PullUpRefactoringProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.PushDownRefactoringProcessor;
import ext.org.eclipse.jdt.internal.corext.refactoring.structure.UseSuperTypeProcessor;
import ext.org.eclipse.jdt.internal.corext.util.Messages;
import ext.org.eclipse.jdt.internal.ui.actions.ActionMessages;
import ext.org.eclipse.jdt.internal.ui.fix.CleanUpRefactoringWizard;
import ext.org.eclipse.jdt.internal.ui.preferences.JavaPreferencesSettings;
import ext.org.eclipse.jdt.internal.ui.refactoring.ChangeSignatureWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.ChangeTypeWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.ConvertAnonymousToNestedWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.ExtractClassWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.ExtractInterfaceWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.ExtractSupertypeWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.InferTypeArgumentsWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.InlineConstantWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.InlineTempWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.IntroduceFactoryWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.IntroduceIndirectionWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.IntroduceParameterObjectWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.IntroduceParameterWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.MoveInnerToTopWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.MoveInstanceMethodWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.MoveMembersWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.PullUpWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.PushDownWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.RefactoringExecutionHelper;
import ext.org.eclipse.jdt.internal.ui.refactoring.RefactoringMessages;
import ext.org.eclipse.jdt.internal.ui.refactoring.UseSupertypeWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.actions.RefactoringStarter;
import ext.org.eclipse.jdt.internal.ui.refactoring.code.InlineMethodWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.code.ReplaceInvocationsWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.reorg.CreateTargetQueries;
import ext.org.eclipse.jdt.internal.ui.refactoring.reorg.DeleteUserInterfaceManager;
import ext.org.eclipse.jdt.internal.ui.refactoring.reorg.NewNameQueries;
import ext.org.eclipse.jdt.internal.ui.refactoring.reorg.ReorgCopyWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.reorg.ReorgMoveWizard;
import ext.org.eclipse.jdt.internal.ui.refactoring.reorg.ReorgQueries;
import ext.org.eclipse.jdt.internal.ui.refactoring.sef.SelfEncapsulateFieldWizard;
