 ...
 *******************************************************************************/
package ext.org.eclipse.jdt.internal.corext.refactoring.tagging;
...
public interface ISimilarDeclarationUpdating {
	 ...
	 *
	 * @param selectedStrategy one of the STRATEGY_* constants in {@link ext.org.eclipse.jdt.internal.corext.refactoring.rename.RenamingNameSuggestor}
	 */
	 ...
	 *
	 * @return one of the STRATEGY_* constants in {@link ext.org.eclipse.jdt.internal.corext.refactoring.rename.RenamingNameSuggestor}
	 */
