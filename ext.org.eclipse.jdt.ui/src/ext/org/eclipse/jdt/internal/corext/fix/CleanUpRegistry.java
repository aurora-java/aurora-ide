...
import ext.org.eclipse.jdt.internal.ui.preferences.cleanup.ContributedCleanUpTabPage;
...
import patch.org.eclipse.jdt.extension.point.create.instance.ExtInstanceCreator;
...
//				ICleanUpConfigurationUI page= (ICleanUpConfigurationUI)fElement.createExecutableExtension(ATTRIBUTE_ID_CLASS);
				ICleanUpConfigurationUI page= (ICleanUpConfigurationUI) ExtInstanceCreator.createInstance(fElement, ATTRIBUTE_ID_CLASS);
...
//				return null;
//			}
			return (ICleanUp) ExtInstanceCreator.createInstance(fElement, ATTRIBUTE_ID_CLASS);
		}
	}
...
//					};
//				}
				fOptionsProvider= (ICleanUpOptionsInitializer)ExtInstanceCreator.createInstance(fElement, ATTRIBUTE_NAME_CLASS);
			}
