...
public final class CompatibilityTemplateStore extends ContributionTemplateStore {
	...
	private ext.org.eclipse.jdt.internal.corext.template.java.TemplateSet fLegacySet;

	public CompatibilityTemplateStore(ContextTypeRegistry registry, IPreferenceStore store, String key, ext.org.eclipse.jdt.internal.corext.template.java.TemplateSet legacySet) {
	...
	private boolean isCodeTemplates() {
		return fLegacySet instanceof ext.org.eclipse.jdt.internal.corext.template.java.CodeTemplates;
	}
