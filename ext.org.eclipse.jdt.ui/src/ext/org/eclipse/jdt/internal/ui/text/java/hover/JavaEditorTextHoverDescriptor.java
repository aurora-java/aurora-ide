...
//			try {
//				fElement.createExecutableExtension(CLASS_ATTRIBUTE);
//			} catch (CoreException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
			return (IJavaEditorTextHover) ExtInstanceCreator.createInstance(
					fElement, CLASS_ATTRIBUTE);
			// return (IJavaEditorTextHover) fElement
			// .createExecutableExtension(CLASS_ATTRIBUTE);
			// } catch (CoreException x) {
			// JavaPlugin.log(new Status(IStatus.ERROR, JavaPlugin
			// .getPluginId(), 0,
			// JavaHoverMessages.JavaTextHover_createTextHover, null));
			// }
	...
	private static JavaEditorTextHoverDescriptor[] createDescriptors(
		...
		List<JavaEditorTextHoverDescriptor> result = new ArrayList<JavaEditorTextHoverDescriptor>(
				elements.length);
	...
	private static void initializeFromPreferences(
		...
		String compiledTextHoverModifiers = JavaPlugin.getDefault()
				.getPreferenceStore()
		...
		String compiledTextHoverModifierMasks = JavaPlugin
				.getDefault()
				.getPreferenceStore()
