 ...
 *******************************************************************************/
package ext.org.eclipse.jdt.internal.ui.text.folding;
...
import patch.org.eclipse.jdt.extension.point.create.instance.PatchInstanceCreator;
...
//				.createExecutableExtension(CLASS);
		IJavaFoldingStructureProvider prov = (IJavaFoldingStructureProvider)PatchInstanceCreator.createInstance(fElement, CLASS);
		return prov;
	}
...
//					.createExecutableExtension(PREFERENCES_CLASS);
			IJavaFoldingPreferenceBlock prefs = (IJavaFoldingPreferenceBlock)ExtInstanceCreator.createInstance(fElement, PREFERENCES_CLASS);
			return prefs;
		} else {
