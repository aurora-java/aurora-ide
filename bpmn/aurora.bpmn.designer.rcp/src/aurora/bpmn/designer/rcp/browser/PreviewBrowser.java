...
public class PreviewBrowser {
	...
	public PreviewBrowser(Composite parent, boolean top) {
		this.parent = parent;
		try {
		...
		browser.addOpenWindowListener(new OpenWindowListener() {
			public void open(WindowEvent event) {
				...
				PreviewBrowser app = new PreviewBrowser(shell, false);
...
//			browser.setUrl("http://localhost:8888/pmg/manager.screen");
			show(false, null, null, false, true, false, false);
		} else {
			browser.addVisibilityWindowListener(new VisibilityWindowListener() {
				...
				public void show(WindowEvent e) {
					...
					PreviewBrowser app = (PreviewBrowser)browser.getData("org.eclipse.swt.examples.browserexample.BrowserApplication");
					app.show(true, e.location, e.size, false, e.menuBar, e.statusBar, false);
				}
			});
