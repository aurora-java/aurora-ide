...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn2.ResourceParameterBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceParameterBindingItemProvider extends BaseElementItemProvider implements
    ...
    protected void addParameterRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                Bpmn2Package.Literals.RESOURCE_PARAMETER_BINDING__PARAMETER_REF, true, false, true,
                null, null, null));
    }
    ...
    /**
     * This returns ResourceParameterBinding.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        try {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/ResourceParameterBinding.png"));
        } catch (java.util.MissingResourceException e) {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/ResourceParameterBinding.gif"));
        }
    }
    ...
    public String getText(Object object) {
        String label = ((ResourceParameterBinding) object).getId();
        return label == null || label.length() == 0 ? getString("_UI_ResourceParameterBinding_type")
                : getString("_UI_ResourceParameterBinding_type") + " " + label;
    }
