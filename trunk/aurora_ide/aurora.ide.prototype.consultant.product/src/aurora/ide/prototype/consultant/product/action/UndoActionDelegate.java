...
public class UndoActionDelegate extends Action implements
		IWorkbenchWindowActionDelegate {

	private IWorkbenchWindow fWindow;

	public UndoActionDelegate() {
		setEnabled(true);
	}

	public UndoActionDelegate(IWorkbenchWindow window, String label) {
		this.fWindow = window;
		setText(label);
		...
		this.setId("aurora.ide.prototype.consultant.product.action.UndoActionDelegate");
