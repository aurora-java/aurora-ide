...
public class Test {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    for (Object object : content) {
	    	org.docx4j.wml.Tr tr = (org.docx4j.wml.Tr)object;
	    	List<Object> content2 = tr.getContent();
	    	for (Object object2 : content2) {
	    		org.docx4j.wml.Tc tc = (org.docx4j.wml.Tc)object2;
	    		tc.getContent().add(wordMLPackage.getMainDocumentPart().createParagraphOfText("XXXXXXX"));
			}
	    }
//	    tbl.getTblPr()
