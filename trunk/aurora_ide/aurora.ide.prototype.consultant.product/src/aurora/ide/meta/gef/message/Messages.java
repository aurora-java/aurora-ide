package aurora.ide.meta.gef.message;

import org.eclipse.osgi.util.NLS;

public class Messages extends NLS {
	private static final String BUNDLE_NAME = "aurora.ide.meta.gef.message.messages"; //$NON-NLS-1$
	...
	public static String ButtonsCreator_4;
