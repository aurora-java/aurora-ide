 ...
 * @since 3.2
 */
public class NewFilteredTree extends Composite {
	 ...
	 */
	public NewFilteredTree(Composite parent, int treeStyle, PatternFilter filter) {
	 ...
	 * @since 3.5
	 */
	public NewFilteredTree(Composite parent, int treeStyle,
	 ...
	 *             look is encouraged
	 */
	protected NewFilteredTree(Composite parent) {
		super(parent, SWT.NONE);
		this.parent = parent;
	}
	 ...
	 * @since 3.5
	 */
	protected NewFilteredTree(Composite parent, boolean useNewLook) {
		super(parent, SWT.NONE);
		this.parent = parent;
		this.useNewLook = useNewLook;
	}
	 ...
	 * @return bold font
	 */
	public static Font getBoldFont(Object element, NewFilteredTree tree,
			PatternFilter filter) {
