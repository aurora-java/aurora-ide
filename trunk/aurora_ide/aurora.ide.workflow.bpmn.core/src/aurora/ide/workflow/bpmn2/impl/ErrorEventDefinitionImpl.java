 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ErrorEventDefinitionImpl#getErrorRef <em>Error Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ErrorEventDefinitionImpl extends EventDefinitionImpl implements
	 ...
	 * @ordered
	 */
	protected aurora.ide.workflow.bpmn2.Error errorRef;
	 ...
	 * @generated
	 */
	public aurora.ide.workflow.bpmn2.Error getErrorRef() {
		if (errorRef != null && errorRef.eIsProxy()) {
			InternalEObject oldErrorRef = (InternalEObject) errorRef;
			errorRef = (aurora.ide.workflow.bpmn2.Error) eResolveProxy(oldErrorRef);
	 ...
	 * @generated
	 */
	public aurora.ide.workflow.bpmn2.Error basicGetErrorRef() {
		return errorRef;
	}
	 ...
	 * @generated
	 */
	public void setErrorRef(aurora.ide.workflow.bpmn2.Error newErrorRef) {
		aurora.ide.workflow.bpmn2.Error oldErrorRef = errorRef;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case Bpmn2Package.ERROR_EVENT_DEFINITION__ERROR_REF:
			setErrorRef((aurora.ide.workflow.bpmn2.Error) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case Bpmn2Package.ERROR_EVENT_DEFINITION__ERROR_REF:
			setErrorRef((aurora.ide.workflow.bpmn2.Error) null);
			return;
		}
