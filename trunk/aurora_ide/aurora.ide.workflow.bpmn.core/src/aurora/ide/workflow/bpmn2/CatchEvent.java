 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.CatchEvent#getDataOutputs <em>Data Outputs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CatchEvent#getDataOutputAssociation <em>Data Output Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CatchEvent#getOutputSet <em>Output Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CatchEvent#getEventDefinitions <em>Event Definitions</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CatchEvent#getEventDefinitionRefs <em>Event Definition Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.CatchEvent#isParallelMultiple <em>Parallel Multiple</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent()
 * @model abstract="true"
...
public interface CatchEvent extends Event {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent_DataOutputs()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent_DataOutputAssociation()
	 * @model containment="true" ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent_OutputSet()
	 * @model containment="true" ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.CatchEvent#getOutputSet <em>Output Set</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link aurora.ide.workflow.bpmn2.EventDefinition}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent_EventDefinitions()
	 * @model containment="true" ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent_EventDefinitionRefs()
	 * @model ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getCatchEvent_ParallelMultiple()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.CatchEvent#isParallelMultiple <em>Parallel Multiple</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
