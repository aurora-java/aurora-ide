 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.InputOutputSpecification#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.InputOutputSpecification#getDataOutputs <em>Data Outputs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.InputOutputSpecification#getInputSets <em>Input Sets</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.InputOutputSpecification#getOutputSets <em>Output Sets</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInputOutputSpecification()
...
public interface InputOutputSpecification extends BaseElement {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInputOutputSpecification_DataInputs()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInputOutputSpecification_DataOutputs()
	 * @model containment="true" ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInputOutputSpecification_InputSets()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInputOutputSpecification_OutputSets()
	 * @model containment="true" required="true" ordered="false"
