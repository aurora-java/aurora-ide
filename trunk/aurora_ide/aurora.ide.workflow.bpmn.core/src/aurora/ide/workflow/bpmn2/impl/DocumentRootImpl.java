...
import aurora.ide.workflow.bpmn2.Activity;
import aurora.ide.workflow.bpmn2.AdHocSubProcess;
import aurora.ide.workflow.bpmn2.Artifact;
import aurora.ide.workflow.bpmn2.Assignment;
import aurora.ide.workflow.bpmn2.Association;
import aurora.ide.workflow.bpmn2.Auditing;
import aurora.ide.workflow.bpmn2.BaseElement;
import aurora.ide.workflow.bpmn2.BoundaryEvent;
import aurora.ide.workflow.bpmn2.Bpmn2Package;
import aurora.ide.workflow.bpmn2.BusinessRuleTask;
import aurora.ide.workflow.bpmn2.CallActivity;
import aurora.ide.workflow.bpmn2.CallChoreography;
import aurora.ide.workflow.bpmn2.CallConversation;
import aurora.ide.workflow.bpmn2.CallableElement;
import aurora.ide.workflow.bpmn2.CancelEventDefinition;
import aurora.ide.workflow.bpmn2.CatchEvent;
import aurora.ide.workflow.bpmn2.Category;
import aurora.ide.workflow.bpmn2.CategoryValue;
import aurora.ide.workflow.bpmn2.Choreography;
import aurora.ide.workflow.bpmn2.ChoreographyActivity;
import aurora.ide.workflow.bpmn2.ChoreographyTask;
import aurora.ide.workflow.bpmn2.Collaboration;
import aurora.ide.workflow.bpmn2.CompensateEventDefinition;
import aurora.ide.workflow.bpmn2.ComplexBehaviorDefinition;
import aurora.ide.workflow.bpmn2.ComplexGateway;
import aurora.ide.workflow.bpmn2.ConditionalEventDefinition;
import aurora.ide.workflow.bpmn2.Conversation;
import aurora.ide.workflow.bpmn2.ConversationAssociation;
import aurora.ide.workflow.bpmn2.ConversationLink;
import aurora.ide.workflow.bpmn2.ConversationNode;
import aurora.ide.workflow.bpmn2.CorrelationKey;
import aurora.ide.workflow.bpmn2.CorrelationProperty;
import aurora.ide.workflow.bpmn2.CorrelationPropertyBinding;
import aurora.ide.workflow.bpmn2.CorrelationPropertyRetrievalExpression;
import aurora.ide.workflow.bpmn2.CorrelationSubscription;
import aurora.ide.workflow.bpmn2.DataAssociation;
import aurora.ide.workflow.bpmn2.DataInput;
import aurora.ide.workflow.bpmn2.DataInputAssociation;
import aurora.ide.workflow.bpmn2.DataObject;
import aurora.ide.workflow.bpmn2.DataObjectReference;
import aurora.ide.workflow.bpmn2.DataOutput;
import aurora.ide.workflow.bpmn2.DataOutputAssociation;
import aurora.ide.workflow.bpmn2.DataState;
import aurora.ide.workflow.bpmn2.DataStore;
import aurora.ide.workflow.bpmn2.DataStoreReference;
import aurora.ide.workflow.bpmn2.Definitions;
import aurora.ide.workflow.bpmn2.DocumentRoot;
import aurora.ide.workflow.bpmn2.Documentation;
import aurora.ide.workflow.bpmn2.EndEvent;
import aurora.ide.workflow.bpmn2.EndPoint;
import aurora.ide.workflow.bpmn2.ErrorEventDefinition;
import aurora.ide.workflow.bpmn2.Escalation;
import aurora.ide.workflow.bpmn2.EscalationEventDefinition;
import aurora.ide.workflow.bpmn2.Event;
import aurora.ide.workflow.bpmn2.EventBasedGateway;
import aurora.ide.workflow.bpmn2.EventDefinition;
import aurora.ide.workflow.bpmn2.ExclusiveGateway;
import aurora.ide.workflow.bpmn2.Expression;
import aurora.ide.workflow.bpmn2.Extension;
import aurora.ide.workflow.bpmn2.ExtensionAttributeValue;
import aurora.ide.workflow.bpmn2.FlowElement;
import aurora.ide.workflow.bpmn2.FlowNode;
import aurora.ide.workflow.bpmn2.FormalExpression;
import aurora.ide.workflow.bpmn2.Gateway;
import aurora.ide.workflow.bpmn2.GlobalBusinessRuleTask;
import aurora.ide.workflow.bpmn2.GlobalChoreographyTask;
import aurora.ide.workflow.bpmn2.GlobalConversation;
import aurora.ide.workflow.bpmn2.GlobalManualTask;
import aurora.ide.workflow.bpmn2.GlobalScriptTask;
import aurora.ide.workflow.bpmn2.GlobalTask;
import aurora.ide.workflow.bpmn2.GlobalUserTask;
import aurora.ide.workflow.bpmn2.Group;
import aurora.ide.workflow.bpmn2.HumanPerformer;
import aurora.ide.workflow.bpmn2.ImplicitThrowEvent;
import aurora.ide.workflow.bpmn2.Import;
import aurora.ide.workflow.bpmn2.InclusiveGateway;
import aurora.ide.workflow.bpmn2.InputOutputBinding;
import aurora.ide.workflow.bpmn2.InputOutputSpecification;
import aurora.ide.workflow.bpmn2.InputSet;
import aurora.ide.workflow.bpmn2.Interface;
import aurora.ide.workflow.bpmn2.IntermediateCatchEvent;
import aurora.ide.workflow.bpmn2.IntermediateThrowEvent;
import aurora.ide.workflow.bpmn2.ItemDefinition;
import aurora.ide.workflow.bpmn2.Lane;
import aurora.ide.workflow.bpmn2.LaneSet;
import aurora.ide.workflow.bpmn2.LinkEventDefinition;
import aurora.ide.workflow.bpmn2.LoopCharacteristics;
import aurora.ide.workflow.bpmn2.ManualTask;
import aurora.ide.workflow.bpmn2.Message;
import aurora.ide.workflow.bpmn2.MessageEventDefinition;
import aurora.ide.workflow.bpmn2.MessageFlow;
import aurora.ide.workflow.bpmn2.MessageFlowAssociation;
import aurora.ide.workflow.bpmn2.Monitoring;
import aurora.ide.workflow.bpmn2.MultiInstanceLoopCharacteristics;
import aurora.ide.workflow.bpmn2.Operation;
import aurora.ide.workflow.bpmn2.OutputSet;
import aurora.ide.workflow.bpmn2.ParallelGateway;
import aurora.ide.workflow.bpmn2.Participant;
import aurora.ide.workflow.bpmn2.ParticipantAssociation;
import aurora.ide.workflow.bpmn2.ParticipantMultiplicity;
import aurora.ide.workflow.bpmn2.PartnerEntity;
import aurora.ide.workflow.bpmn2.PartnerRole;
import aurora.ide.workflow.bpmn2.Performer;
import aurora.ide.workflow.bpmn2.PotentialOwner;
import aurora.ide.workflow.bpmn2.Property;
import aurora.ide.workflow.bpmn2.ReceiveTask;
import aurora.ide.workflow.bpmn2.Relationship;
import aurora.ide.workflow.bpmn2.Rendering;
import aurora.ide.workflow.bpmn2.Resource;
import aurora.ide.workflow.bpmn2.ResourceAssignmentExpression;
import aurora.ide.workflow.bpmn2.ResourceParameter;
import aurora.ide.workflow.bpmn2.ResourceParameterBinding;
import aurora.ide.workflow.bpmn2.ResourceRole;
import aurora.ide.workflow.bpmn2.RootElement;
import aurora.ide.workflow.bpmn2.ScriptTask;
import aurora.ide.workflow.bpmn2.SendTask;
import aurora.ide.workflow.bpmn2.SequenceFlow;
import aurora.ide.workflow.bpmn2.ServiceTask;
import aurora.ide.workflow.bpmn2.Signal;
import aurora.ide.workflow.bpmn2.SignalEventDefinition;
import aurora.ide.workflow.bpmn2.StandardLoopCharacteristics;
import aurora.ide.workflow.bpmn2.StartEvent;
import aurora.ide.workflow.bpmn2.SubChoreography;
import aurora.ide.workflow.bpmn2.SubConversation;
import aurora.ide.workflow.bpmn2.SubProcess;
import aurora.ide.workflow.bpmn2.Task;
import aurora.ide.workflow.bpmn2.TerminateEventDefinition;
import aurora.ide.workflow.bpmn2.TextAnnotation;
import aurora.ide.workflow.bpmn2.ThrowEvent;
import aurora.ide.workflow.bpmn2.TimerEventDefinition;
import aurora.ide.workflow.bpmn2.Transaction;
import aurora.ide.workflow.bpmn2.UserTask;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getAdHocSubProcess <em>Ad Hoc Sub Process</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getFlowElement <em>Flow Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getArtifact <em>Artifact</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getAssignment <em>Assignment</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getAssociation <em>Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getAuditing <em>Auditing</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getBaseElement <em>Base Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getBaseElementWithMixedContent <em>Base Element With Mixed Content</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getBoundaryEvent <em>Boundary Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getBusinessRuleTask <em>Business Rule Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCallableElement <em>Callable Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCallActivity <em>Call Activity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCallChoreography <em>Call Choreography</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCallConversation <em>Call Conversation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getConversationNode <em>Conversation Node</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCancelEventDefinition <em>Cancel Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEventDefinition <em>Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getRootElement <em>Root Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCatchEvent <em>Catch Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCategoryValue <em>Category Value</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getChoreography <em>Choreography</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCollaboration <em>Collaboration</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getChoreographyActivity <em>Choreography Activity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getChoreographyTask <em>Choreography Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCompensateEventDefinition <em>Compensate Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getComplexBehaviorDefinition <em>Complex Behavior Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getComplexGateway <em>Complex Gateway</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getConditionalEventDefinition <em>Conditional Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getConversation <em>Conversation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getConversationAssociation <em>Conversation Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getConversationLink <em>Conversation Link</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCorrelationKey <em>Correlation Key</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCorrelationProperty <em>Correlation Property</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCorrelationPropertyBinding <em>Correlation Property Binding</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCorrelationPropertyRetrievalExpression <em>Correlation Property Retrieval Expression</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getCorrelationSubscription <em>Correlation Subscription</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataAssociation <em>Data Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataInput <em>Data Input</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataInputAssociation <em>Data Input Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataObject <em>Data Object</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataObjectReference <em>Data Object Reference</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataOutput <em>Data Output</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataOutputAssociation <em>Data Output Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataState <em>Data State</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataStore <em>Data Store</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDataStoreReference <em>Data Store Reference</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEndEvent <em>End Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEndPoint <em>End Point</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getError <em>Error</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getErrorEventDefinition <em>Error Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEscalation <em>Escalation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEscalationEventDefinition <em>Escalation Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getEventBasedGateway <em>Event Based Gateway</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getExclusiveGateway <em>Exclusive Gateway</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getExtension <em>Extension</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getExtensionElements <em>Extension Elements</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getFlowNode <em>Flow Node</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getFormalExpression <em>Formal Expression</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGateway <em>Gateway</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalBusinessRuleTask <em>Global Business Rule Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalChoreographyTask <em>Global Choreography Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalConversation <em>Global Conversation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalManualTask <em>Global Manual Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalScriptTask <em>Global Script Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalTask <em>Global Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGlobalUserTask <em>Global User Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getHumanPerformer <em>Human Performer</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getPerformer <em>Performer</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getResourceRole <em>Resource Role</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getImplicitThrowEvent <em>Implicit Throw Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getImport <em>Import</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getInclusiveGateway <em>Inclusive Gateway</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getInputSet <em>Input Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getIntermediateCatchEvent <em>Intermediate Catch Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getIntermediateThrowEvent <em>Intermediate Throw Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getIoBinding <em>Io Binding</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getIoSpecification <em>Io Specification</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getItemDefinition <em>Item Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getLane <em>Lane</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getLaneSet <em>Lane Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getLinkEventDefinition <em>Link Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getLoopCharacteristics <em>Loop Characteristics</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getManualTask <em>Manual Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMessageEventDefinition <em>Message Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMessageFlow <em>Message Flow</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMessageFlowAssociation <em>Message Flow Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMonitoring <em>Monitoring</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getMultiInstanceLoopCharacteristics <em>Multi Instance Loop Characteristics</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getOutputSet <em>Output Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getParallelGateway <em>Parallel Gateway</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getParticipantAssociation <em>Participant Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getParticipantMultiplicity <em>Participant Multiplicity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getPartnerEntity <em>Partner Entity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getPartnerRole <em>Partner Role</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getPotentialOwner <em>Potential Owner</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getReceiveTask <em>Receive Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getResourceAssignmentExpression <em>Resource Assignment Expression</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getResourceParameter <em>Resource Parameter</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getResourceParameterBinding <em>Resource Parameter Binding</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getScript <em>Script</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getScriptTask <em>Script Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSendTask <em>Send Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSequenceFlow <em>Sequence Flow</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getServiceTask <em>Service Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSignal <em>Signal</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSignalEventDefinition <em>Signal Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getStandardLoopCharacteristics <em>Standard Loop Characteristics</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getStartEvent <em>Start Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSubChoreography <em>Sub Choreography</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSubConversation <em>Sub Conversation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getSubProcess <em>Sub Process</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getTask <em>Task</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getTerminateEventDefinition <em>Terminate Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getText <em>Text</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getTextAnnotation <em>Text Annotation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getThrowEvent <em>Throw Event</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getTimerEventDefinition <em>Timer Event Definition</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getTransaction <em>Transaction</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.DocumentRootImpl#getUserTask <em>User Task</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	 ...
	 * @generated
	 */
	public aurora.ide.workflow.bpmn2.Error getError() {
		return (aurora.ide.workflow.bpmn2.Error) getMixed().get(
	...
	public NotificationChain basicSetError(
			aurora.ide.workflow.bpmn2.Error newError, NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
	 ...
	 * @generated
	 */
	public void setError(aurora.ide.workflow.bpmn2.Error newError) {
		((FeatureMap.Internal) getMixed()).set(
	 ...
	 * @generated
	 */
	public aurora.ide.workflow.bpmn2.Process getProcess() {
		return (aurora.ide.workflow.bpmn2.Process) getMixed().get(
	...
	public NotificationChain basicSetProcess(
			aurora.ide.workflow.bpmn2.Process newProcess, NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
	 ...
	 * @generated
	 */
	public void setProcess(aurora.ide.workflow.bpmn2.Process newProcess) {
		((FeatureMap.Internal) getMixed()).set(
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Bpmn2Package.DOCUMENT_ROOT__END_POINT:
			...
			return;
		case Bpmn2Package.DOCUMENT_ROOT__ERROR:
			setError((aurora.ide.workflow.bpmn2.Error) newValue);
			return;
		case Bpmn2Package.DOCUMENT_ROOT__ERROR_EVENT_DEFINITION:
		...
		case Bpmn2Package.DOCUMENT_ROOT__POTENTIAL_OWNER:
			...
			return;
		case Bpmn2Package.DOCUMENT_ROOT__PROCESS:
			setProcess((aurora.ide.workflow.bpmn2.Process) newValue);
			return;
		case Bpmn2Package.DOCUMENT_ROOT__PROPERTY:
	...
	public void eUnset(int featureID) {
		...
		case Bpmn2Package.DOCUMENT_ROOT__END_POINT:
			...
			return;
		case Bpmn2Package.DOCUMENT_ROOT__ERROR:
			setError((aurora.ide.workflow.bpmn2.Error) null);
			return;
		case Bpmn2Package.DOCUMENT_ROOT__ERROR_EVENT_DEFINITION:
		...
		case Bpmn2Package.DOCUMENT_ROOT__POTENTIAL_OWNER:
			...
			return;
		case Bpmn2Package.DOCUMENT_ROOT__PROCESS:
			setProcess((aurora.ide.workflow.bpmn2.Process) null);
			return;
		case Bpmn2Package.DOCUMENT_ROOT__PROPERTY:
