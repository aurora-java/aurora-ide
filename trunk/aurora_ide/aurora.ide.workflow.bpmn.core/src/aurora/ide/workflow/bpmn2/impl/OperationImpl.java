 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.OperationImpl#getInMessageRef <em>In Message Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.OperationImpl#getOutMessageRef <em>Out Message Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.OperationImpl#getErrorRefs <em>Error Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.OperationImpl#getImplementationRef <em>Implementation Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.OperationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends BaseElementImpl implements Operation {
	 ...
	 * @ordered
	 */
	protected EList<aurora.ide.workflow.bpmn2.Error> errorRefs;
	 ...
	 * @generated
	 */
	public List<aurora.ide.workflow.bpmn2.Error> getErrorRefs() {
		if (errorRefs == null) {
			errorRefs = new EObjectResolvingEList<aurora.ide.workflow.bpmn2.Error>(
					aurora.ide.workflow.bpmn2.Error.class, this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Bpmn2Package.OPERATION__ERROR_REFS:
			getErrorRefs().clear();
			getErrorRefs()
					.addAll((Collection<? extends aurora.ide.workflow.bpmn2.Error>) newValue);
			return;
		case Bpmn2Package.OPERATION__IMPLEMENTATION_REF:
