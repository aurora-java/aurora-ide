 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.StartEvent#isIsInterrupting <em>Is Interrupting</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getStartEvent()
...
public interface StartEvent extends CatchEvent {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getStartEvent_IsInterrupting()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.StartEvent#isIsInterrupting <em>Is Interrupting</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
