 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.InteractionNode#getIncomingConversationLinks <em>Incoming Conversation Links</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.InteractionNode#getOutgoingConversationLinks <em>Outgoing Conversation Links</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInteractionNode()
...
public interface InteractionNode extends EObject {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInteractionNode_IncomingConversationLinks()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getInteractionNode_OutgoingConversationLinks()
