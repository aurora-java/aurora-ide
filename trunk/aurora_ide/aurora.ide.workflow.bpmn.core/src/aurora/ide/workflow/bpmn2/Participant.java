 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.Participant#getInterfaceRefs <em>Interface Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Participant#getEndPointRefs <em>End Point Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Participant#getParticipantMultiplicity <em>Participant Multiplicity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Participant#getName <em>Name</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Participant#getProcessRef <em>Process Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getParticipant()
...
public interface Participant extends BaseElement, InteractionNode {
	 ...
	 * The list contents are of type {@link aurora.ide.workflow.bpmn2.Interface}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getParticipant_InterfaceRefs()
	 * @model ordered="false"
	 ...
	 * The list contents are of type {@link aurora.ide.workflow.bpmn2.EndPoint}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getParticipant_EndPointRefs()
	 * @model ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getParticipant_ParticipantMultiplicity()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Participant#getParticipantMultiplicity <em>Participant Multiplicity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getParticipant_Name()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Participant#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setProcessRef(aurora.ide.workflow.bpmn2.Process)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getParticipant_ProcessRef()
	 * @model ordered="false"
	 *        extendedMetaData="kind='attribute' name='processRef'"
	 * @generated
	 */
	aurora.ide.workflow.bpmn2.Process getProcessRef();

	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Participant#getProcessRef <em>Process Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setProcessRef(aurora.ide.workflow.bpmn2.Process value);
