 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.ThrowEvent#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ThrowEvent#getDataInputAssociation <em>Data Input Association</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ThrowEvent#getInputSet <em>Input Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ThrowEvent#getEventDefinitions <em>Event Definitions</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.ThrowEvent#getEventDefinitionRefs <em>Event Definition Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getThrowEvent()
 * @model abstract="true"
...
public interface ThrowEvent extends Event {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getThrowEvent_DataInputs()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getThrowEvent_DataInputAssociation()
	 * @model containment="true" ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getThrowEvent_InputSet()
	 * @model containment="true" ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.ThrowEvent#getInputSet <em>Input Set</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getThrowEvent_EventDefinitions()
	 * @model containment="true" ordered="false"
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getThrowEvent_EventDefinitionRefs()
	 * @model ordered="false"
