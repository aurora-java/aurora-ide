 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.Lane#getPartitionElement <em>Partition Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Lane#getFlowNodeRefs <em>Flow Node Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Lane#getChildLaneSet <em>Child Lane Set</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Lane#getName <em>Name</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Lane#getPartitionElementRef <em>Partition Element Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getLane()
...
public interface Lane extends BaseElement {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getLane_PartitionElement()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Lane#getPartitionElement <em>Partition Element</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link aurora.ide.workflow.bpmn2.FlowNode}.
	 * It is bidirectional and its opposite is '{@link aurora.ide.workflow.bpmn2.FlowNode#getLanes <em>Lanes</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getLane_FlowNodeRefs()
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getLane_ChildLaneSet()
	 * @model containment="true" ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Lane#getChildLaneSet <em>Child Lane Set</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getLane_Name()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Lane#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getLane_PartitionElementRef()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Lane#getPartitionElementRef <em>Partition Element Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
