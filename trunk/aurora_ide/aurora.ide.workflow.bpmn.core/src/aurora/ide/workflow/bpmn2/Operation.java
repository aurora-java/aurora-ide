 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.Operation#getInMessageRef <em>In Message Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Operation#getOutMessageRef <em>Out Message Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Operation#getErrorRefs <em>Error Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Operation#getImplementationRef <em>Implementation Ref</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.Operation#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getOperation()
...
public interface Operation extends BaseElement {
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getOperation_InMessageRef()
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Operation#getInMessageRef <em>In Message Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getOperation_OutMessageRef()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Operation#getOutMessageRef <em>Out Message Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link aurora.ide.workflow.bpmn2.Error}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getOperation_ErrorRefs()
	 * @model ordered="false"
	 *        extendedMetaData="kind='element' name='errorRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	List<aurora.ide.workflow.bpmn2.Error> getErrorRefs();
	 ...
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getOperation_ImplementationRef()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Operation#getImplementationRef <em>Implementation Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see aurora.ide.workflow.bpmn2.Bpmn2Package#getOperation_Name()
	 * @model required="true" ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn2.Operation#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
