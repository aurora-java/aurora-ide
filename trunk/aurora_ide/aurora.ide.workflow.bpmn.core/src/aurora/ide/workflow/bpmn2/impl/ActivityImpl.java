 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getIoSpecification <em>Io Specification</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getBoundaryEventRefs <em>Boundary Event Refs</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getDataInputAssociations <em>Data Input Associations</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getDataOutputAssociations <em>Data Output Associations</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getLoopCharacteristics <em>Loop Characteristics</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getCompletionQuantity <em>Completion Quantity</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#isIsForCompensation <em>Is For Compensation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn2.impl.ActivityImpl#getStartQuantity <em>Start Quantity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
