 ...
 * </copyright>
 */
package aurora.ide.workflow.bpmn.dd.dc.impl;

import aurora.ide.workflow.bpmn.dd.dc.Bounds;
import aurora.ide.workflow.bpmn.dd.dc.DcPackage;
import aurora.ide.workflow.bpmn.dd.dc.DocumentRoot;
import aurora.ide.workflow.bpmn.dd.dc.Font;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.dc.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.dc.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.dc.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.dc.impl.DocumentRootImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.dc.impl.DocumentRootImpl#getFont <em>Font</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.dc.impl.DocumentRootImpl#getPoint <em>Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
