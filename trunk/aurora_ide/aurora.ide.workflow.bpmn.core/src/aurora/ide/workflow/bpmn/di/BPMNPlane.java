 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.di.BPMNPlane#getBpmnElement <em>Bpmn Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNPlane()
...
public interface BPMNPlane extends Plane {
	 ...
	 * @see aurora.ide.workflow.bpmn.di.BpmnDiPackage#getBPMNPlane_BpmnElement()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link aurora.ide.workflow.bpmn.di.BPMNPlane#getBpmnElement <em>Bpmn Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
