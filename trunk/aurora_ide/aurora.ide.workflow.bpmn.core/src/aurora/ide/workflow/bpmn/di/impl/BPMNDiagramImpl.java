...
import aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNDiagramImpl#getPlane <em>Plane</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNDiagramImpl#getLabelStyle <em>Label Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BPMNDiagramImpl extends DiagramImpl implements BPMNDiagram {
	...
	public aurora.ide.workflow.bpmn.dd.di.DiagramElement getRootElement() {
		return getPlane();
	}
} //BPMNDiagramImpl
