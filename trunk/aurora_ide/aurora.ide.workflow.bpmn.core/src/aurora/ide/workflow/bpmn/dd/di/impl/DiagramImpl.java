 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl#getOwnedStyle <em>Owned Style</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl#getRootElement <em>Root Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl#getId <em>Id</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl#getName <em>Name</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.impl.DiagramImpl#getResolution <em>Resolution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
