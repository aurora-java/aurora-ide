 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.dd.di.Plane#getPlaneElement <em>Plane Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see aurora.ide.workflow.bpmn.dd.di.DiPackage#getPlane()
 * @model abstract="true"
...
public interface Plane extends Node {
	 ...
	 * @see aurora.ide.workflow.bpmn.dd.di.DiPackage#getPlane_PlaneElement()
