...
import aurora.ide.workflow.bpmn.dd.di.impl.LabeledShapeImpl;
...
import aurora.ide.workflow.bpmn.di.ParticipantBandKind;
 ...
 * <ul>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#getBpmnElement <em>Bpmn Element</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#getChoreographyActivityShape <em>Choreography Activity Shape</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#isIsExpanded <em>Is Expanded</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#isIsHorizontal <em>Is Horizontal</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#isIsMarkerVisible <em>Is Marker Visible</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#isIsMessageVisible <em>Is Message Visible</em>}</li>
 *   <li>{@link aurora.ide.workflow.bpmn.di.impl.BPMNShapeImpl#getParticipantBandKind <em>Participant Band Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
