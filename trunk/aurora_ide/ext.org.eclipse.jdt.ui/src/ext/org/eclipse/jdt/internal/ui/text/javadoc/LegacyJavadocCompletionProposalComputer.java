...
import patch.org.eclipse.jdt.ui.text.java.IJavaCompletionProposalComputer;
...
//			try {
				...
				for (int i= 0; i < elements.length; i++) {
					result[i]=(IJavadocCompletionProcessor) ExtInstanceCreator.createInstance(elements[i], "class");
