...
package ext.org.eclipse.jdt.internal.corext.refactoring.generics;
...
import ext.org.eclipse.jdt.internal.corext.dom.HierarchicalASTVisitor;
import ext.org.eclipse.jdt.internal.corext.refactoring.rename.MethodChecks;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.GenericType;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.ParameterizedType;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.TType;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.TypeVariable;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.WildcardType;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ArrayElementVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.CollectionElementVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ConstraintVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ImmutableTypeVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.IndependentTypeVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ParameterTypeVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ParameterizedTypeVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ReturnTypeVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.TTypes;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.TypeVariable2;
import ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.VariableVariable2;
...
//			fTCModel.createSubtypeConstraint(classTypeVariable, boundType);
		...
		for (int i= 0; i < arguments.size(); i++) {
			...
			if (! methodBinding.isVarargs() || i < lastParamIdx) {
				...
				if (i == lastParamIdx && canAssignToVararg(
						...
						(ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType)) {
					//OK: argument will not be packed into an array
				} else {
					declaredParameterType= ((ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType).getComponentType();
				}
			}
			...
			if (declaredParameterType.isTypeVariable()) {
				...
				TType declaredElementType= ((ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.ArrayType) declaredParameterType).getElementType();
	...
	private boolean canAssignToVararg(TType rhs, ext.org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.ArrayType lhs) {
