...
import ext.org.eclipse.jdt.internal.ui.preferences.ProblemSeveritiesPreferencePage;
...
public class AccessRulesDialog extends StatusDialog {
	...
	private class TypeRestrictionAdapter implements IListAdapter<IAccessRule>, IDialogFieldListener {
		/**
		 * @see ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.IListAdapter#customButtonPressed(ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.ListDialogField, int)
		 */
		...
		/**
		 * @see ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.IListAdapter#selectionChanged(ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.ListDialogField)
		 */
		public void selectionChanged(ListDialogField<IAccessRule> field) {
			doSelectionChanged(field);
		}
		/**
		 * @see ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.IListAdapter#doubleClicked(ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.ListDialogField)
		 */
		...
		/**
		 * @see ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.IDialogFieldListener#dialogFieldChanged(ext.org.eclipse.jdt.internal.ui.wizards.dialogfields.DialogField)
		 */
