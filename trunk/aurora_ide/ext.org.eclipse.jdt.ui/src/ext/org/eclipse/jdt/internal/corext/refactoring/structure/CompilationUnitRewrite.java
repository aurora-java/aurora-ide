...
public class CompilationUnitRewrite {
	 ...
	 */
	public ext.org.eclipse.jdt.internal.corext.refactoring.changes.CompilationUnitChange createChange() throws CoreException {
		CompilationUnitChange change= createChange(true);
		if (change == null)
			return null;
		return new ext.org.eclipse.jdt.internal.corext.refactoring.changes.CompilationUnitChange(change);
	}
